...
import { useForm } from "react-hook-form";
import { SignupValidation } from "../../lib/validation"; // Updated import
import { z } from "zod";
...
import {
  useCreateUserAccount,
  useSignInAccount,
} from "../../lib/react-query/queriesAndMutations"; // Updated import
    ...
    <Form {...form}>
      <div className="flex flex-col py-2 sm:w-420 flex-center">
        <div className="flex flex-row gap-2">
          ...
          />
          <h3 className="pt-2 font-bold">Connectify.</h3>
        </div>
